		...
		if (domain.includes('market.yandex.ru')) {
			try {
				...
				if (cardIndex !== -1 && pathParts[cardIndex + 1]) {
					...
					const cleanName = productName.replace(/-/g, ' ').replace(/\b\w/g, l => l.toUpperCase());
...
>
	...
	/>
	<svg class="url-badge-fallback" style="display:none;" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
		<path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path>
		<polyline points="15,3 21,3 21,9"></polyline>
		<line x1="10" y1="14" x2="21" y2="3"></line>
	</svg>
	<span class="url-badge-domain">{finalDisplayText}</span>
	<svg class="url-badge-external" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
		<path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"></path>
		<polyline points="15,3 21,3 21,9"></polyline>
		<line x1="10" y1="14" x2="21" y2="3"></line>
	</svg>
